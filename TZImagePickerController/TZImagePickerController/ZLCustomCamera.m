...
- (void)onStartRecord
{
    ...
    if (![self.movieFileOutPut isRecording]) {
        NSURL *temp = [[NSFileManager defaultManager] URLsForDirectory:NSCachesDirectory inDomains:NSUserDomainMask].firstObject;
        NSURL *url = [temp URLByAppendingPathComponent:@"xo_temp.mp4" isDirectory:false];
