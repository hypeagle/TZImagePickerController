...
/// 视频录制分辨率 默认 UIImagePickerControllerQualityType1280x720
@property (assign, nonatomic) UIImagePickerControllerQualityType videoQuality;
...
@property (nonatomic, assign) BOOL cannotSelectNoLocation;
